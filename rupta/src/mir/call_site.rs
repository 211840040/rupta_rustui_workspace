...
//ref to rustc_middle::ty::GenericArgs
/*
vector of GenericArg
Ty/Const/Lifetime
 */
...
/// what does destination mean result here?
#[derive(Clone, PartialEq, Eq, Hash, Debug)]
...
/*
F should implement Copy and can be converted into FuncId by Into<FuncId>
 */
...
pub struct AssocCallGroup<I, F, P> {
    ...
    // FuncId is the callee function id.

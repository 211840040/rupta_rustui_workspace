...
impl<'a, 'rta, 'tcx, 'compilation> BodyVisitor<'a, 'rta, 'tcx, 'compilation> {
            ...
            mir::Rvalue::Cast(cast_kind, operand, ty) => {
                ...
                match specialized_ty.kind() {
                    ...
                    _ => {
                        ...
                        /* #060 @lzq may cause some problem with coercion source : explict(AsCast) or implict */
    ...
    fn visit_terminator(
        ...
        match kind {
            ...
            /* #061 @lzq Vec<Spanned<mir::Operand<'tcx>>> -> &Box<[Spanned<mir::Operand<'tcx>>]> */
            self.visit_call(func, &args, destination, location),
            /* #062 @lzq Vec<Spanned<mir::Operand<'tcx>>> -> &Box<[Spanned<mir::Operand<'tcx>>]> */
    ...
    fn visit_projection_type(
        ...
        for elem in projection.iter() {
            match elem {
                ...
                mir::ProjectionElem::UnwrapUnsafeBinder(new_ty) => {
                    ty = self.substs_specializer.specialize_generic_argument_type(*new_ty);
                }
            }
        }
        ty
